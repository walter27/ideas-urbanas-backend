...
provinciaSchema.post('save', function (provincia, next) {
    ...
    //Actualizar Cantón
    CantonModel.updateMany(  { 'obj_Provincia._id': provincia._id },
    ...
    //Actualizar Research
    ResearchModel.updateMany(   { 'obj_Canton.obj_Provincia._id': provincia._id },
                                { 'obj_Canton.obj_Provincia': provincia }, 
                                {"multi": true},
                                    function (err, result) {
                                        if (err) {
                                            return next(err);
    ...
    //Actualizar Data
    DataModel.updateMany(   { 'obj_Canton.obj_Provincia._id': provincia._id },
                            { 'obj_Canton.obj_Provincia': provincia }, 
                            {"multi": true},
                                    function (err, result) {
                                        if (err) {
